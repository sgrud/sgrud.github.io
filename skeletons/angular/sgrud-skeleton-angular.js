...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
return e.\u0275prov=le({token:e,providedIn:"root",factory:function(){return null}}),e}(),oa=m(function e(t){g(this,e),this.full=t,this.major=t.split(".")[0],this.minor=t.split(".")[1],this.patch=t.split(".").slice(2).join(".")}),zD=new oa("14.2.8"),uu={};function du(e){return e.ngOriginalError}
/**
   * @license
   * Copyright Google LLC All Rights Reserved.
   *
